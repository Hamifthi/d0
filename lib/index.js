...
var D0 = function () {
    ...
    _createClass(D0, [{
        ...
        value: function d(n, setTo) {
            ...
            if (this.ready) while (this.dimensions[this.count - 1] === 0) {
                this.dimensions.pop();
            }return this;
        }
        ...
        value: function subtract(point) {
            ...
            try {
                for (var _iterator3 = arguments[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    ...
                    this.eachWith(_point3, function (index, i, j) {
        ...
        value: function abs() {
            ...
            return this.each(function (index, value) {
                return _this5.d(index, Math.abs(value));
            });
        }
        ...
        value: function toString() {
            ...
            try {
                for (var _iterator6 = this.dimensions[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                    var d = _step6.value;
                    ret += d + ", ";
                }
            } catch (err) {
